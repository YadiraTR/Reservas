<?php
    ...
    $iduser = $_GET['id'];
    $sql = mysqli_query($conection,"SELECT id_ruta, desc_ruta, costo_ruta
    FROM ruta WHERE id_ruta = $iduser");
    ...
    if(isset($_POST['submit']))
    {
            ...
            $sql_update = mysqli_query($conection,"UPDATE ruta

            SET desc_ruta= '$desc_ruta',
            costo_ruta = '$costo_ruta'
            WHERE id_ruta = $iduser");
            ...
            if($sql_update)
            {
              ...
              window.location ='lista_rutas.php';
              </script>";
                          ...
                          <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group input-group-outline mb-3">                                       
                                        <input type="text" class="form-control" name="desc_ruta" id="desc_ruta"  aria-describedby="email-addon"  value="<?php echo $desc_ruta ?>">
                                    </div>
                                </div>
                                    
                                <div class="col-md-4">                                      
                                    <label for="exampleInputEmail1"> Costo de pasaje</label>                                       
                                    <div class="input-group input-group-outline mb-3">                                        
                                    <input type="text" class="form-control" name="costo_ruta" id="costo_ruta"  aria-describedby="email-addon"  value="<?php echo $costo_ruta?>">                                       
                                    </div>
                                </div>
                            </div>
