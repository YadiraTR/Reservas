...
if (isset($_POST['submit'])) {
  ...
  $sql = mysqli_query($conection, "SELECT * FROM pasajero
      ...
      if ($result_sql == 0) {
        ...
        while ($data = mysqli_fetch_array($sql)) {
          ...
          $telefono_pasajero = $data['telefono_pasajero'];
          $email_pasajero = $data['email_pasajero'];
        }
      }

  $query_insert = mysqli_query($conection, "INSERT INTO reserva(id_empleado,id_pasajero,id_prog,id_asie,Fecha_reserva, estado)
   VALUES('$id_empl','$id_pasajero','$id_progra','$id_asie','$Fecha_reserva','1')");
  if ($query_insert) {
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Viajes disponibles</h6>#05c8d9
              </div>
              ...
              <div class="row align-form-map">  
               <form method="post">
                  <div class='row'>
                     ...
                     <div class="col-md-4">
                       <label for="pasajero">CI pasajero </label>
                       <div class="input-group input-group-outline mb-3">
                          <?php
                          $query_PASAJERO = mysqli_query($conection, "SELECT * FROM pasajero");
                          $result_PASAJERO = mysqli_num_rows($query_PASAJERO);
                          ?>
                          <select name="pasajero" id="pasajero" class='form-control'>
                            <?php
                            if ($result_PASAJERO > 0) {
                              while ($id_pasajero = mysqli_fetch_array($query_PASAJERO)) {
                            ?>
                                <option value="<?php echo $id_pasajero["id_pasajero"]; ?>"><?php echo $id_pasajero["ci_pasajero"]; ?></option>
                            <?php
                              }
                            }
                            ?>
                       ...
                       <div class="input-group input-group-outline mb-3">
                       <input style="display:none" id='empleado' type='text' class='form-control' value='<?php echo $id_empl ?>' readonly>                     
                       </div>
