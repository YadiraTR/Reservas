<?php
    include "../conexion.php";
      ...
      //-----------------------------------------------------------
    if(!empty($_POST)){
        $Id_empleado= $_POST['id_bus'];

        //PARA ELIMINACIÓN FÍSICA
        //$query_delete = mysqli_query($conection, "DELETE FROM usuario WHERE Idusuario = $idusuario");

        //PARA ELIMINACIÓN LÓGICA
        $query_delete = mysqli_query($conection, "UPDATE programacion SET Estado = 0 WHERE id_prog = $Id_empleado");
        //---------------------------------------------------------------
    ...
    if(empty($_REQUEST['id'] || $_REQUEST['id'] == 1)){
        ...
        $query = mysqli_query($conection, "SELECT v.id_prog, r.desc_ruta, b.placa, v.fecha, v.hora 
                            FROM programacion as v 
                            INNER JOIN ruta as r ON v.id_ruta = r.id_ruta 
                            INNER JOIN bus as b on v.id_bus = b.id_bus
                            WHERE id_prog = $Id_empleado");
          ...
          <div class="card my-4">
            ...
            <section id="container">
                <div class="data_delete">
                    ...
                    <p>Ruta <span><?php echo $desc_ruta ?></span></p>
                    <p>bus: <span><?php echo $placa ?></span></p>
                    <p>Fecha viaje: <span><?php echo $fecha ?></span></p>
                    <p>Hora viaje: <span><?php echo $hora ?></span></p>

                    <form method="post" action="">
                        <input type="hidden" name="id_bus" value="<?php echo $Id_empleado; ?>">
                        <a href="lista_buses.php" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1">Cancelar</a> <a</a>
