<?php
    ...
    {  
        ...
        $query_insert = mysqli_query($conection,"INSERT INTO ruta(desc_ruta, costo_ruta, Estado)
        VALUES('$desc_ruta','$costo_ruta', '1')");
        if($query_insert)
        {
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Registro de  rutas</h6>
              </div>
            <ul class="navbar-nav d-lg-block d-none">
              <br>
                 <a href="./Lista_rutas.php" class="btn btn-sm  bg-gradient-primary mb-2 me-1  " onclick="smoothToPricing('pricing-soft-ui')">Atras</a>    <br>             
                 <br>
                </ul>  
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                      <div class="input-group input-group-outline mb-3">
                                        ...
                                        <input name="desc_ruta" id="placa" class="form-control"  type="text" required>
                                      </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      <div class="input-group input-group-outline mb-3">        
                                       <input name="costo_ruta" id="costo_ruta" type="number" class='form-control' >
                                      </div>
                                    </div>
                                    </div> 
