                  ...
                  <div class="table100  align-items-center ver6 m-b-110">    
                    ...
                    <thead>
							<tr class="row100 head">
                                ...
                                <th class="column100 column1" data-column="column1">Precio</th>
                                <th class="column100 column1" data-column="column1">Placa bus</th>
						...
						<?php
							...
							$query = mysqli_query($conection, "SELECT p.id_prog, r.desc_ruta, r.costo_ruta, b.placa, p.fecha, p.hora 
                            FROM programacion as p INNER JOIN bus as b on p.id_bus = b.id_bus 
                            INNER JOIN ruta as r on r.id_ruta = p.id_ruta WHERE p.fecha = '$date' and r.id_ruta = '$ruta'");
                            ...
                            {if($result > 0){
								...
								?>
								 <tr>
                                    ...
                                    <td class="column100 column1" data-column="column1"><?php echo $data["costo_ruta"]?></td>
                                    ...
                                    <a style="color: green" class = "link_edit" href="Reserva.php?id=<?php echo $data["id_prog"]?>">Reservar </a>
								   	</td>
