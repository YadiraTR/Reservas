<?php
    include "../conexion.php";
      ...
      if(!empty($_POST)){
        ...
        //$query_delete = mysqli_query($conection, "DELETE FROM ruta WHERE id_ruta = $Id_ruta");
        

        //PARA ELIMINACIÓN LÓGICA
        $query_delete = mysqli_query($conection, "UPDATE ruta SET Estado = 0 WHERE id_ruta = $Id_ruta");
        ...
        else
        {
            ...
            window.location ='lista_buses.php';
            </script>";echo "Error al eliminar el registro";
        }
    }
    if(empty($_REQUEST['id'] || $_REQUEST['id'] == 1)){
        ...
        $Id_ruta = $_REQUEST['id']; 
        $query = mysqli_query($conection, "SELECT desc_ruta, costo_ruta
                            FROM ruta
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <section id="container">
                ...
                <p>Costo de la ruta: <span><?php echo $costo_ruta ?></span></p>
