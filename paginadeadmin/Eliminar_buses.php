<?php
    ...
    if(!empty($_POST)){
        ...
        $query_delete = mysqli_query($conection, "UPDATE bus SET Estado = 0 WHERE id_bus = $Id_empleado");
        //---------------------------------------------------------------
    ...
    if(empty($_REQUEST['id'] || $_REQUEST['id'] == 1)){
        ...
        $query = mysqli_query($conection, "SELECT u.placa, r.nombre_empleado
                            FROM bus u
                            INNER JOIN empleado r
                            ON u.id_empleado = r.id_empleado
                            WHERE id_bus = $Id_empleado");
          ...
          <div class="card my-4">
            ...
            <section id="container">
                <div class="data_delete">
                    ...
                    <p>Placa: <span><?php echo $Nombre ?></span></p>
                    <p>Conductor: <span><?php echo $rol ?></span></p>
