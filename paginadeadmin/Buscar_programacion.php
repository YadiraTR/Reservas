          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Reservas disponibles</h6>
              </div>
            </div>
                  ...
                  <div class="form-41-mian py-5">
                    <div class="container py-lg-4">
                       <div class="row align-form-map">  
                           <form action="Prereserva.php" method="POST"enctype="multipart/form-data" class="form-control"  class="signin-form">
                        ...
                        <label for="ruta">Rutas disponible: </label>
                            ...
                            <div class="mb-3">
                            <input class="btn btn-sm  bg-gradient-primary mb-2 me-1  " type="submit" value="Buscar" >
                            </div>
