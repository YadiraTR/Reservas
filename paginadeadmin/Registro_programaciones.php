<?php
    ...
    {  
        ...
        $sqluser = "SELECT id_bus, id_ruta FROM programacion WHERE id_bus='$id_bus' AND id_ruta='$id_ruta' AND fecha = '$fecha' ";
        $resultadouser= $conexion ->query($sqluser);
        $filas = $resultadouser->num_rows;
        if($filas > 0)
        {
          echo "<script>
          alert('Ya existe una programación con los datos ingresados');
          window.location ='Lista_programacion_viajes.php';
          </script>";
        }
        else
        {
        $query_insert = mysqli_query($conection,"INSERT INTO programacion(id_bus, id_ruta, fecha, hora, Estado)
        VALUES('$id_bus','$id_ruta','$fecha', '$hora', '1')");
        if($query_insert)
        {
        ...
        else
        {
            ...
            echo "<script>
            alert('Error al registrar una programación');
            window.location ='Lista_programacion_viajes.php';
            </script>";
        }    }    
    }   
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Programacion de viajes</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <div class="content">
                  <div class="form-41-mian py-3">
                                ...
                                <div class="row">
                                    ...
                                    <label class="form-label">Bus</label>  
                                        <div class="input-group input-group-outline mb-3">
                                            ...
                                            <?php
                                                $query_rol = mysqli_query($conection,"SELECT * FROM bus WHere Estado=1");
                                            ...
                                            <?php
                                                if($result_rol > 0)
                                                {
                                                    ...
                                                    {
                                                    ?> 
                                                        <option value="<?php echo $rol["id_bus"]; ?>"><?php echo $rol["placa"]; ?></option>           
                                                    <?php
                                                    }
                                                }
                                            ?>                                                         
                                    ...
                                    <label class="form-label">Ruta</label>  
                                        ...
                                        <?php
                                                $query_rol = mysqli_query($conection,"SELECT * FROM ruta WHere Estado=1");
                                                $result_rol = mysqli_num_rows($query_rol);
                                              ?>
