<?php
    ...
    {  
                ...
                $sqluser = "SELECT id_pasajero FROM pasajero WHERE email_pasajero ='$email_pasajero' or ci_pasajero = '$ci_pasajero' ";
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Registro de Pasajeros</h6>
              </div>
            </div>
                                ...
                                <div class="col-lg-11 form-inner-cont">
                                    ...
                                    <div class="col-md-4">
                                      <div class="input-group input-group-outline mb-3">
                                        ...
                                        <input name="nombre_pasajero" id="nombre_pasajero" class="form-control"  type="text" required >
                                      </div>
                                    </div>
                                    <div class="col-md-4">
                                      <div class="input-group input-group-outline mb-3">
                                        <label class="form-label">Apellido Paterno </label>
                                        <input name="apellido_paterno_pasajero" id="apellido_paterno_pasajero" class="form-control"  type="text" required >
                                      </div>
                                    </div>
                                    <div class="col-md-4">
                                      <div class="input-group input-group-outline mb-3">
                                        <label class="form-label">Apellido Materno</label>
                                        <input name="apellido_materno_pasajero" id="apellido_materno_pasajero" class="form-control"  type="text" required >
                                      </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4" >  <label ><br></label>
                                      <div class="input-group input-group-outline mb-3">
                                        ...
                                        <input name="ci_pasajero" id="ci_pasajero"  class="form-control" type="text" required>
                                      </div>
                                    </div>
                                    <div class="col-md-4">
                                      <label >Fecha Nacimiento :</label>
                                      <div class="input-group input-group-outline mb-3">                                   
                                      <input name="fech_nacimiento" id="fech_nacimiento" class="form-control"  type="date"  required>                                               
                                      </div>
                                    </div>
                                    <div class="col-md-4">  <label ><br></label>
                                      <div class="input-group input-group-outline mb-3">
                                        <label class="form-label">Teléfono</label>
                                        <input name="telefono_pasajero" id="telefono_pasajero" class="form-control"  type="text" required>                                                   
                                      </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                      <div class="input-group input-group-outline mb-3">
                                        ...
                                        <input name="email_pasajero" id="email_pasajero" class="form-control"  type="email" required>
                                      </div>
                                    </div>
                                    <div class="col-md-4">
                                      <div class="input-group input-group-outline mb-3">
                                        <label class="form-label">Password</label>
                                        <input name="password_pasajero" id="password_pasajero" class="form-control" type="Password" required>
                                      </div>
                                    </div>
