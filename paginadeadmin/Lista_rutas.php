...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark"  id="sidenav-main">
    ...
    <hr class="horizontal light mt-0 mb-3">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="Lista_rutas.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
               ...
               <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Lista de rutas</h6>
                        </div>
                        <ul class="navbar-nav d-lg-block d-none">
                        <br>
                            <a href="Registrar_rutas.php" class="btn btn-sm  bg-gradient-primary mb-2 me-1  " onclick="smoothToPricing('pricing-soft-ui')">Agregar nuevo</a>    <br>             
                            <br>
                            </ul>
                        </div>
                                            ...
                                            <table data-vertable="ver6" id="tabla" class="table table-striped table-bordered" style="width:100%" data-sort="tabla">             
                                                <thead>
                                                    <tr class="row100 head">
                                                        ...
                                                        <th class="column100 column1" data-column="column1">Descripción</th>
                                                        <th class="column100 column3" data-column="column3">Costo de pasaje</th>
                                                ...
                                                <tbody>   
                                                    <?php
                                                        ...
                                                        $query = mysqli_query($conection, "SELECT * FROM ruta WHERE Estado = 1");
                                                        ...
                                                        if($result > 0){
                                                            ...
                                                            ?>
                                                                <tr>         
                                                                    ...
                                                                    <td class="column100 column1" data-column="column3"><?php echo $data["costo_ruta"]?></td>
                                                                    
                                                                    <td class="column100 column8" data-column="column8">
                                                                        <a style="color: white" class="material-icons ms-auto text-dark cursor-pointer" href="Modificar_rutas.php?id=<?php echo $data["id_ruta"]?>"title="Editar">editar</a>
                                                                        <a style="color: red" class="far fa-trash-alt "  href="Eliminar_ruta.php?id=<?php echo $data["id_ruta"]?>" title="Eliminar"><p></p></a>
                                                                    </td>
