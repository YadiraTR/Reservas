<?php
    include "../conexion.php";
      ...
      if(!empty($_POST)){
        ...
        $query_delete = mysqli_query($conection, "UPDATE empleado SET Estado = 0 WHERE id_empleado = $Id_empleado");
        //---------------------------------------------------------------
    ...
    if(empty($_REQUEST['id'] || $_REQUEST['id'] == 1)){
        ...
        $query = mysqli_query($conection, "SELECT u.nombre_empleado, u.email_empleado, r.descripcion_rol
                            FROM empleado u
                            INNER JOIN rol r
          ...
          <div class="card my-4">
            ...
            <section id="container">
                ...
                <p>Nombre: <span><?php echo $Nombre ?></span></p>
                    <p>email: <span><?php echo $usuario ?></span></p>
                    <p>Tipo de Usuario: <span><?php echo $rol ?></span></p>

                    <form method="post" action="">
                        <input type="hidden" name="id_empleado" value="<?php echo $Id_empleado; ?>">
                        <a href="lista_empleados.php" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1">Cancelar</a> <a</a>
