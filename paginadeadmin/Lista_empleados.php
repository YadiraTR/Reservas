          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Lista de empleados</h6>
              </div>
              <ul class="navbar-nav d-lg-block d-none">
              <br>
                 <a href="./Registro_empleados.php" class="btn btn-sm  bg-gradient-primary mb-2 me-1  " onclick="smoothToPricing('pricing-soft-ui')">Agregar nuevo</a>    <br>             
                <br>
                </ul>
            </div>
                ...
                <div id="div1"class="scroll-bar">
                  <div class="table100  align-items-center ver6 m-b-110">    
                    <table data-vertable="ver6" id="tabla" class="table table-striped table-bordered" style="width:100%" data-sort="tabla">
                      ...
                      <tbody>    
                        <?php    
                          $query = mysqli_query($conection, "SELECT u.id_empleado, u.nombre_empleado, u.apellido_paterno_empleado, u.apellido_materno_empleado,
