      ...
      <div class="container-fluid py-4">
         <div class="card-body px-4 pt-0 pb-2">
           <ul class="navbar-nav d-lg-block d-none">
               <li class="nav-item">
                   <a href="./Reservas.php" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1" onclick="smoothToPricing('pricing-soft-ui')">Agregar </a>
               </li>        
            </ul>
         </div>
